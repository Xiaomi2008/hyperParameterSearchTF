...
#hparams = hparam.HParams(num_hidden_units=100, activations=['relu', 'tanh'])
hparams = HParams(
...
tuner = tuner(hparams, run_config, FLAGS)

learn_runner.tune(experiment_fn=_create_my_experiment, tuner=tuner)